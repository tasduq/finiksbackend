...
const finiksDataSchema = new Schema({
  ...
  voterTags: { type: Array, default: [] },
  surveys: { type: Array, default: [] },
  lastInfluenced: { type: String, default: "Not Influnced Yet" },
});

// userSchema.plugin(uniqueValidator);

module.exports = mongoose.model("Finiksdata", finiksDataSchema);
